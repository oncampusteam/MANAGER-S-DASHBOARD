        ...
        SingleChildScrollView(
          child: Container(
            ...
            children: [
              ...
              // Group 1 //
              Container(
                padding: EdgeInsets.symmetric(horizontal: Constant.width * 0.05 ),
                child: Row(
                  ...
                  Row(
                    ...
                    Container(
                      ...
                      child: Image.asset("assets/Screens/Home/Dashboard/userIcon.png")
                    ),
                    SizedBox(width: 10.w),
                      SizedBox(
                  ...
                  Image.asset("assets/Screens/Home/Dashboard/search.png", height: Constant.height * 0.04, width: Constant.width * 0.1)
                ],),
              ),
              // Group 1 //
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    return Row(
                      children: [
                      SizedBox(width: index==0 ? Constant.width*0.05 : Constant.width * 0.025),
                      Container(
                        height: 170.h,
                      ...
                      SizedBox(width: index==itemCount-1? Constant.width*0.05 : 0.w),
                    ],);
                  }),
              ),
            ...
            Container(
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Image.asset("assets/Screens/Home/Dashboard/frame  2.png"),
                          ),
                          SizedBox(width: 16.w),
                          SizedBox(
                            width: MediaQuery.of(context).size.width - (Constant.width * 0.1 + 56.w + 16.w) ,
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Column(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 56.h,
                      child: Switch(
                        thumbColor: const WidgetStatePropertyAll(Color.fromARGB(255, 255, 255, 255)),
                        activeColor: const Color(0xFF00EFD1),
                        value: instantBooking, onChanged: (value){
                        setState(() {
              ...
              Container(
                ...
                Container(
                      height: 212.h,
                      width: MediaQuery.of(context).size.width,
                      padding: EdgeInsets.symmetric(horizontal: Constant.width * 0.1),
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: tapped ? GestureDetector(
                    onTap: (){
                        floatingActionButtonAction();
                     
                    },
                    child: Container(
                      padding: EdgeInsets.symmetric(horizontal: Constant.width * 0.02),
                      height: Constant.height * 0.06,
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        children: [
                            Container(
                              ...
                              child: Image.asset("assets/Screens/Home/Dashboard/message.png",)),
                              SizedBox(
                      ...
                      child: Row(
                        children: [
                            Container(
                              ...
                              child: Image.asset("assets/Screens/Home/Dashboard/graduate.png",)),
                              SizedBox(
                                height: Constant.height * 0.029,
                                child: FittedBox(
                                  child: text(
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: tapped ? Icon(Icons.close, size: 40, color: Colors.white,)
