                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset("assets/Screens/Home/Listings/check.png"),
                    ),
                    SizedBox(width: 15.w,),
                    text(
                      content: "Active",
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Image.asset("assets/Screens/Home/Listings/calender.png"),
                            ),
                            SizedBox(width: 15.w),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView(
                              ...
                              children: [
                                Icon(Icons.star, color: Color(0xFF121417), size: 19),
                                Icon(Icons.star, color: Color(0xFF121417), size: 19),
                                Icon(Icons.star, color: Color(0xFF121417), size: 19),
                                Icon(Icons.star, color: Color(0xFF121417), size: 19),
                                Icon(Icons.star, color: Color(0xFF121417), size: 19),
