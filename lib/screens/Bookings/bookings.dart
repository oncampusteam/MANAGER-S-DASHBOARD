                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      width: 165.w,
                      margin: EdgeInsets.only(left: 7.w, top: 4.h, bottom: 4.h),
                      decoration: BoxDecoration(
                      ...
                      child: text(
                        ...
                        fontSize: 12.sp,
                        textColor: !approved ? Colors.black : Color(0xFF898C8F)
                      ),
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      alignment: Alignment.center,
                      width: 165.w,
                      margin: EdgeInsets.only(right: 7.w, top: 3.h, bottom: 3.h),
                      decoration: BoxDecoration(
                        color: approved?Colors.white: Colors.transparent,
                        borderRadius: BorderRadius.circular(10.r)
                      ),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    return Container(
                      ...
                      height: 85.h,
                      decoration: BoxDecoration(
                        border: Border(bottom: BorderSide(color: Color.fromRGBO(0, 0, 0, 0.1)))
                      ),
                      child: Row(
                        children: [
                          Container(
                          ...
                          SizedBox(width: 16.w),
                          SizedBox(
                            width: MediaQuery.of(context).size.width - (40.w + 56.w + 16.w) ,
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Column(
