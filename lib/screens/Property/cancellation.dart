                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      rowCheckBox(
                        boldText: "No Refunds After Booking",
                        secondText: " - Once\n confirmed, bookings are final",
                        index: 0,
                      ),
                      rowCheckBox(
                        boldText: "Non-Refundable Deposit & Rent",
                        secondText: " - both\nare not refundable",
                        index: 1,
                      ),
                      ...
                      rowCheckBox(
                        boldText: "Cancel 7 Days Before Move-in",
                        secondText:
                            " - Get\n50% rent back (deposit is non-\nrefundable).",
                        index: 2,
                      ),
                      rowCheckBox(
                        boldText: "Cancel within 7 Days Before Move-in",
                        secondText: " - No\nrefund.",
                        index: 3,
                      ),
                      SizedBox(height: 30.h),
                      ...
                      rowCheckBox(
                        boldText: "Cancel Between 48 Hours of Booking",
                        secondText: " -\nFull refund of rent.",
                        index: 4,
                      ),
                      rowCheckBox(
                        boldText: "Cancel After 48 Hours",
                        secondText: " - Rent may be\nrefunded.",
                        index: 5,
                      ),
                      SizedBox(height: 30.h),
                      Container(
                      ...
                      rowCheckBox(
                        boldText:
                            "if the tenants cancels on or after the\n move in",
                        secondText:
                            " - no refund is given for the first\nmonth",
                        index: 6,
                      ),
                      rowCheckBox(
                        boldText: "Non-Refundable Until Rebooked",
                        secondText:
                            " -\nRent is non-refundable unless another\ntenants books the room.",
                        index: 7,
                      ),
                      SizedBox(height: 30.h),
                      Container(
                      ...
                      rowCheckBox(
                        boldText: "Must rebook Before Deadline",
                        secondText:
