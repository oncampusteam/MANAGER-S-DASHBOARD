...
class AmenitiesPerRoom extends StatefulWidget {
  const AmenitiesPerRoom({super.key, required this.roomAvailable});
...
class _AmenitiesPerRoomState extends State<AmenitiesPerRoom> {
  ...
  void initState() {
    ...
    amenities = List.generate(length + 1, (index) {
      return List.generate(23, (index) {
        return false;
      });
    });
    bills = List.generate(length + 1, (index) {
      return List.generate(9, (index) {
        return false;
      });
    });
    security = List.generate(11, (index) {
      return false;
    });
                                  ...
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          widget.roomAvailable[i] == 6
                                              ? "Self Contained Room"
                                              : "${widget.roomAvailable[i]}-in-a-room",
                                          style: TextStyle(
                                            fontSize: 22.sp,
                                            fontFamily: "Poppins",
                                            fontWeight: FontWeight.w500,
                                      ...
                                      amenity_[localIndex]
                                          ? ShowAmenities(
                                              ...
                                              onTap: () {
                                                ...
                                                amenityIndex = i;
                                                debugPrint(
                                                  "This is the amenityIndex: $amenityIndex",
                                                );
                                                setState(() {
                                                  slideUp = true;
                                                  currentIndex = 0;
                    ...
                    child: slideUp
                        ? GestureDetector(
                            onTap: () {
                              ...
                              if (amenityRoomListType[amenityIndex]
                                  .isNotEmpty) {
                                amenity_[amenityIndex] = true;
                              } else if (amenityRoomListType[amenityIndex]
                                  .isEmpty) {
                                amenity_[amenityIndex] = false;
                              }
                              if (billsRoomListType[billsIndex].isNotEmpty) {
                                bill_[amenityIndex] = true;
                              } else if (billsRoomListType[billsIndex]
                                  .isEmpty) {
                                bill_[amenityIndex] = false;
                              }
                  ...
                  Positioned(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: ScrollSheet(
                        ...
                        typeList: amenityRoomListType.isEmpty
                            ? [{}]
                            : amenityRoomListType[amenityIndex],
                  ...
                  Positioned(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: ScrollSheet(
                        ...
                        scrollHeight: MediaQuery.of(context).size.height * 0.81,
                        typeList: billsRoomListType.isEmpty
                            ? [{}]
                            : billsRoomListType[billsIndex],
