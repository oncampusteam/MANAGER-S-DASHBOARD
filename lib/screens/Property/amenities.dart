                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        amenities_
                            ? ShowAmenities(
                                typeList: amenitiesDetails.detailsList,
                                onTap: () {
                                  setState(() {
                                    slideUp = true;
                                    currentIndex = 0;
                        ...
                        bills_
                            ? ShowAmenities(
                                typeList: billsDetails.detailsList,
                                onTap: () {
                                  setState(() {
                                    slideUp = true;
                                    currentIndex = 1;
                        ...
                        security_
                            ? ShowAmenities(
                                typeList: securityDetails.detailsList,
                                onTap: () {
                                  setState(() {
                                    slideUp = true;
                                    currentIndex = 2;
                ...
                Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ScrollSheet(
                      ...
                      buildList: amenitiesDetails.amenityBuildList,
                      typeList: amenitiesDetails.detailsList,
                      type: amenitiesDetails.bools,
                ...
                Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ScrollSheet(
                      ...
                      scrollHeight: MediaQuery.of(context).size.height * 0.81,
                      typeList: billsDetails.detailsList,
                      type: billsDetails.bools,
                      buildList: billsDetails.billsBuildList,
                      enlargeDontCare: false,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ScrollSheet(
                      ...
                      scrollHeight: MediaQuery.of(context).size.height * 0.81,
                      typeList: securityDetails.detailsList,
                      type: securityDetails.bools,
                      buildList: securityDetails.buildList,
                    ),
                  ),
                ),
              ],
