                        ...
                        Positioned(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: const Color(0xFF00EFD1),
                              borderRadius: BorderRadius.circular(
                                containerToColor == 2 || containerToColor == 3
                                    ? 0
                                    : 12.r,
                              ),
                            ),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: const Color(0xFF00EFD1),
                              borderRadius: BorderRadius.circular(
                                containerToColor == 2 ? 12.r : 0,
                              ),
                            ),
                            height: 5.h,
                            width: containerToColor == 3
                                ? width
                                : containerToColor == 0 || containerToColor == 1
                                ? 0
                                : (width) * percentageToColor,
                          ),
                        ),
...
class BottomNavBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color =
          const Color(0xFF00EFD1) // same color as your image
      ..style = PaintingStyle.fill;
