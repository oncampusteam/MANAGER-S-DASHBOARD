...
Widget buildTopIconsRow() {
  ...
  Widget buildLineChartCard({
    ...
    List<String> monthLabels = const ["Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar"] ,
    ...
    return Container(
      ...
      child: Card(
        shadowColor: useHostelOwnerDashboardProperties ? Colors.transparent : null,
        color: Colors.white,
        shape: useHostelOwnerDashboardProperties? null :RoundedRectangleBorder(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: useHostelOwnerDashboardProperties ? null : EdgeInsets.symmetric(horizontal: 20.w,),
              child: Text(
                title,
                style: TextStyle(
                  fontSize: 16.sp,
            ...
            Container(
              ...
              child: Row(children: [
                text(
                  ...
                  textColor: useHostelOwnerDashboardProperties? Color(0xFF637587):Color(0xFF4D7D99),
                  fontSize: 16.sp,
                ),
                SizedBox(width: 5),
                text(
            ...
            const SizedBox(height: 20),
            Container(
              padding: useHostelOwnerDashboardProperties ? EdgeInsets.symmetric(horizontal: 35.w,) : EdgeInsets.symmetric(horizontal: 40.w,),
              ...
              child: buildLineChart(
                ...
                spots: spots,
                maxX: maxX,
                useHostelOwnerDashboardProperties : useHostelOwnerDashboardProperties,
              )
            ),
          ],
        ),
