                            ...
                            child: Column(
                              children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                    DescriptionCard(
                                    enlargedImage: widget.enlargeDontCare == null ? firstIndex == 6 ? true : false : widget.enlargeDontCare!,
                                    screenWidth: MediaQuery.of(context).size.width,
                                    imageUrl: widget.buildList[firstIndex]["ImagePath"]!,
                                    textDescription: widget.buildList[firstIndex]["label"]!,
                                    onTap: (){
                                      onTap(
                                        widget.type[firstIndex],
                                        firstIndex,
                                        widget.type,
                                        widget.buildList[firstIndex]["ImagePath"]!,
                                        widget.buildList[firstIndex]["label"]!,
                                        widget.typeList,
                                      );
                                    },
                                    ...
                                    DescriptionCard(
                                    enlargedImage: widget.enlargeDontCare == null ? secondIndex == 5 ? true : false : widget.enlargeDontCare!,
                                    screenWidth: MediaQuery.of(context).size.width,
                                    imageUrl: widget.buildList[secondIndex]["ImagePath"]!,
                                    textDescription: widget.buildList[secondIndex]["label"]!,
                                    onTap: (){
                                      onTap(
                                        widget.type[secondIndex],
                                        secondIndex,
                                        widget.type,
                                        widget.buildList[secondIndex]["ImagePath"]!,
                                        widget.buildList[secondIndex]["label"]!,
                                        widget.typeList,
                                      );
                                    },
                                    selected: widget.type[secondIndex]
                                    )
                                    else (Container(color: Colors.red,width: 100.w))
                                    ],)
                            ],)
                          );
                        })
